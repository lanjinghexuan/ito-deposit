...
-- 插入测试城市数据 (使用WGS84坐标系的正确坐标)
INSERT INTO `city` (`name`, `code`, `latitude`, `longitude`, `status`) VALUES
('郑州市', '410100', 34.7466, 113.6253, 1),     -- 郑州市中心坐标 (WGS84)
('北京市', '110100', 39.9042, 116.4074, 1),     -- 北京市中心坐标 (WGS84)
('上海市', '310100', 31.2304, 121.4737, 1),     -- 上海市中心坐标 (WGS84)
('广州市', '440100', 23.1291, 113.2644, 1),     -- 广州市中心坐标 (WGS84)
('深圳市', '440300', 22.5431, 114.0579, 1);     -- 深圳市中心坐标 (WGS84)

-- 插入测试寄存点数据 (使用WGS84坐标系)
...
-- 郑州市寄存点
(1, '郑州火车站', '郑州市二七区二马路82号', 34.7466, 113.6253, 5, 10, 15, '06:00-24:00', '0371-12345678'),
(1, '郑州东站', '郑州市金水区心怡路1号', 34.7173, 113.7444, 8, 12, 20, '05:30-24:00', '0371-87654321'),
