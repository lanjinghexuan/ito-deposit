...
const file_api_helloworld_v1_order_proto_rawDesc = "" +
	"\n" +
	"\x1dapi/helloworld/v1/order.proto\x12\x11api.helloworld.v1\x1a\x1cgoogle/api/annotations.proto\"\x1a\n" +
	"\x18ManageOrderSearchRequest\"\x18\n" +
	"\x16ManageOrderSearchReply\"\x94\x03\n" +
	"\tOrderInfo\x12\x0e\n" +
	...
	"\x03Msg\x18\x02 \x01(\tR\x03Msg2\xc7\x06\n" +
	"\x05Order\x12v\n" +
	...
	"\tShowOrder\x12#.api.helloworld.v1.ShowOrderRequest\x1a!.api.helloworld.v1.ShowOrderReply\"\x1a\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/orders/show\x12\x8d\x01\n" +
	"\x11ManageOrderSearch\x12+.api.helloworld.v1.ManageOrderSearchRequest\x1a).api.helloworld.v1.ManageOrderSearchReply\" \x82\xd3\xe4\x93\x02\x1a:\x01*\"\x15/manage/orders/searchB7\n" +
...
var file_api_helloworld_v1_order_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_api_helloworld_v1_order_proto_goTypes = []any{
	(*ManageOrderSearchRequest)(nil), // 0: api.helloworld.v1.ManageOrderSearchRequest
	(*ManageOrderSearchReply)(nil),   // 1: api.helloworld.v1.ManageOrderSearchReply
	(*OrderInfo)(nil),                // 2: api.helloworld.v1.OrderInfo
	(*CreateOrderRequest)(nil),       // 3: api.helloworld.v1.CreateOrderRequest
	(*CreateOrderReply)(nil),         // 4: api.helloworld.v1.CreateOrderReply
	(*UpdateOrderRequest)(nil),       // 5: api.helloworld.v1.UpdateOrderRequest
	(*UpdateOrderReply)(nil),         // 6: api.helloworld.v1.UpdateOrderReply
	(*DeleteOrderRequest)(nil),       // 7: api.helloworld.v1.DeleteOrderRequest
	(*DeleteOrderReply)(nil),         // 8: api.helloworld.v1.DeleteOrderReply
	(*GetOrderRequest)(nil),          // 9: api.helloworld.v1.GetOrderRequest
	(*GetOrderReply)(nil),            // 10: api.helloworld.v1.GetOrderReply
	(*ListOrderRequest)(nil),         // 11: api.helloworld.v1.ListOrderRequest
	(*ListOrderReply)(nil),           // 12: api.helloworld.v1.ListOrderReply
	(*ShowOrderRequest)(nil),         // 13: api.helloworld.v1.ShowOrderRequest
	(*ShowOrderReply)(nil),           // 14: api.helloworld.v1.ShowOrderReply
}
var file_api_helloworld_v1_order_proto_depIdxs = []int32{
	2,  // 0: api.helloworld.v1.UpdateOrderReply.order:type_name -> api.helloworld.v1.OrderInfo
	2,  // 1: api.helloworld.v1.GetOrderReply.order:type_name -> api.helloworld.v1.OrderInfo
	2,  // 2: api.helloworld.v1.ListOrderReply.orders:type_name -> api.helloworld.v1.OrderInfo
	2,  // 3: api.helloworld.v1.ShowOrderReply.order:type_name -> api.helloworld.v1.OrderInfo
	3,  // 4: api.helloworld.v1.Order.CreateOrder:input_type -> api.helloworld.v1.CreateOrderRequest
	5,  // 5: api.helloworld.v1.Order.UpdateOrder:input_type -> api.helloworld.v1.UpdateOrderRequest
	7,  // 6: api.helloworld.v1.Order.DeleteOrder:input_type -> api.helloworld.v1.DeleteOrderRequest
	9,  // 7: api.helloworld.v1.Order.GetOrder:input_type -> api.helloworld.v1.GetOrderRequest
	11, // 8: api.helloworld.v1.Order.ListOrder:input_type -> api.helloworld.v1.ListOrderRequest
	13, // 9: api.helloworld.v1.Order.ShowOrder:input_type -> api.helloworld.v1.ShowOrderRequest
	0,  // 10: api.helloworld.v1.Order.ManageOrderSearch:input_type -> api.helloworld.v1.ManageOrderSearchRequest
	4,  // 11: api.helloworld.v1.Order.CreateOrder:output_type -> api.helloworld.v1.CreateOrderReply
	6,  // 12: api.helloworld.v1.Order.UpdateOrder:output_type -> api.helloworld.v1.UpdateOrderReply
	8,  // 13: api.helloworld.v1.Order.DeleteOrder:output_type -> api.helloworld.v1.DeleteOrderReply
	10, // 14: api.helloworld.v1.Order.GetOrder:output_type -> api.helloworld.v1.GetOrderReply
	12, // 15: api.helloworld.v1.Order.ListOrder:output_type -> api.helloworld.v1.ListOrderReply
	14, // 16: api.helloworld.v1.Order.ShowOrder:output_type -> api.helloworld.v1.ShowOrderReply
	1,  // 17: api.helloworld.v1.Order.ManageOrderSearch:output_type -> api.helloworld.v1.ManageOrderSearchReply
