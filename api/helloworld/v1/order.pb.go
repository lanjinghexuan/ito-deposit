...
const file_helloworld_v1_order_proto_rawDesc = "" +
	"\n" +
	"\x19helloworld/v1/order.proto\x12\x11api.helloworld.v1\x1a\x1cgoogle/api/annotations.proto\"\x1a\n" +
...
var file_helloworld_v1_order_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
