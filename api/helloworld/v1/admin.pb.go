...
const file_api_helloworld_v1_admin_proto_rawDesc = "" +
	"\n" +
	"\x1dapi/helloworld/v1/admin.proto\x12\x11api.helloworld.v1\x1a\x1cgoogle/api/annotations.proto\"\x88\x03\n" +
...
var file_api_helloworld_v1_admin_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
