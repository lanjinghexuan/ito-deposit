...
const (
	...
	Nearby_GetAllLockerPoints_FullMethodName           = "/api.helloworld.v1.Nearby/GetAllLockerPoints"
)
...
type NearbyClient interface {
	...
	// 获取所有寄存点（不依赖城市）
	GetAllLockerPoints(ctx context.Context, in *GetAllLockerPointsRequest, opts ...grpc.CallOption) (*SearchLockerPointsInCityReply, error)
}
...
func (c *nearbyClient) GetAllLockerPoints(ctx context.Context, in *GetAllLockerPointsRequest, opts ...grpc.CallOption) (*SearchLockerPointsInCityReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SearchLockerPointsInCityReply)
	err := c.cc.Invoke(ctx, Nearby_GetAllLockerPoints_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NearbyServer interface {
	...
	// 获取所有寄存点（不依赖城市）
	GetAllLockerPoints(context.Context, *GetAllLockerPointsRequest) (*SearchLockerPointsInCityReply, error)
...
func (UnimplementedNearbyServer) GetAllLockerPoints(context.Context, *GetAllLockerPointsRequest) (*SearchLockerPointsInCityReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllLockerPoints not implemented")
}
...
func _Nearby_GetAllLockerPoints_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAllLockerPointsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NearbyServer).GetAllLockerPoints(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Nearby_GetAllLockerPoints_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NearbyServer).GetAllLockerPoints(ctx, req.(*GetAllLockerPointsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Nearby_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetAllLockerPoints",
			Handler:    _Nearby_GetAllLockerPoints_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/helloworld/v1/nearby.proto",
}
