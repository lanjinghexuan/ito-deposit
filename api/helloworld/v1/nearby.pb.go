...
func (x *GetMyNearbyInfoReply) Reset() {
	*x = GetMyNearbyInfoReply{}
	mi := &file_helloworld_v1_nearby_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetMyNearbyInfoReply) Descriptor() ([]byte, []int) {
	return file_helloworld_v1_nearby_proto_rawDescGZIP(), []int{17}
}
...
var file_helloworld_v1_nearby_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
