...
func (x *CreateLocalRequest) Reset() {
	*x = CreateLocalRequest{}
	mi := &file_api_helloworld_v1_home_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateLocalRequest) Descriptor() ([]byte, []int) {
	return file_api_helloworld_v1_home_proto_rawDescGZIP(), []int{10}
}
...
func (x *CreateLocalReply) Reset() {
	*x = CreateLocalReply{}
	mi := &file_api_helloworld_v1_home_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateLocalReply) Descriptor() ([]byte, []int) {
	return file_api_helloworld_v1_home_proto_rawDescGZIP(), []int{11}
}
...
var file_api_helloworld_v1_home_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
