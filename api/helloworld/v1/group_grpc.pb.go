...
const (
	Group_CreateGroup_FullMethodName = "/api.helloworld.v1.Group/CreateGroup"
	Group_UpdateGroup_FullMethodName = "/api.helloworld.v1.Group/UpdateGroup"
...
var Group_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.helloworld.v1.Group",
