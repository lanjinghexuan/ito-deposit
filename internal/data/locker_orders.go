...
type LockerOrders struct {
	Id                  int32          `gorm:"column:id;type:int;comment:订单ID;primaryKey;" json:"id"`                                                       // 订单ID
	...
	CabinetId           int64          `gorm:"column:cabinet_id;type:varchar(20);comment:柜子ID;not null;" json:"cabinet_id"`                                 // 柜子ID
