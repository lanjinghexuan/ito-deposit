...
type LockerPricingRules struct {
	...
	FeeType          int8      `gorm:"column:fee_type;type:tinyint;comment:1-计时收费 2-按日收费 3-混合模式;not null;" json:"fee_type"`           // 1-计时收费 2-按日收费 3-混合模式
	LockerType       int8      `gorm:"column:locker_type;type:tinyint;comment:1-小柜子 2-大柜子 3-全部类型;not null;" json:"locker_type"`         // 1-小柜子 2-大柜子 3-全部类型
	...
	ExpireTime       time.Time `gorm:"column:expire_time;type:datetime;comment:失效时间;default:NULL;" json:"expire_time"`                        // 失效时间
