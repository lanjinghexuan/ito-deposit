...
type Server struct {
	...
	Etcd          *Server_Etcd           `protobuf:"bytes,5,opt,name=etcd,proto3" json:"etcd,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Server_Jwt) GetAuthkey() string {
	if x != nil {
		return x.Authkey
	}
	return ""
...
func (x *Server_Pprof) GetSwitch() bool {
	if x != nil {
		return x.Switch
	}
	return false
...
func (x *Server_Etcd) GetDialTimeout() *durationpb.Duration {
	if x != nil {
...
func (x *Server_Etcd) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
type Data_Database struct {
	...
	Master        string                 `protobuf:"bytes,2,opt,name=master,proto3" json:"master,omitempty"` // 主库 DSN（写）
	Slave         string                 `protobuf:"bytes,3,opt,name=slave,proto3" json:"slave,omitempty"`   // 从库 DSN（读）
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Data_Database) GetMaster() string {
	if x != nil {
		return x.Master
	}
	return ""
...
func (x *Data_Database) GetSlave() string {
	if x != nil {
		return x.Slave
	}
	return ""
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\x04data\x18\x02 \x01(\v2\x10.kratos.api.DataR\x04data\"\x8d\x05\n" +
	"\x06Server\x12+\n" +
	"\x04http\x18\x01 \x01(\v2\x17.kratos.api.Server.HTTPR\x04http\x12+\n" +
	"\x04grpc\x18\x02 \x01(\v2\x17.kratos.api.Server.GRPCR\x04grpc\x12(\n" +
	"\x03jwt\x18\x03 \x01(\v2\x16.kratos.api.Server.JwtR\x03jwt\x12.\n" +
	"\x05pprof\x18\x04 \x01(\v2\x18.kratos.api.Server.PprofR\x05pprof\x12+\n" +
	"\x04etcd\x18\x05 \x01(\v2\x17.kratos.api.Server.EtcdR\x04etcd\x1ai\n" +
	"\x04HTTP\x12\x18\n" +
	...
	"\x06switch\x18\x02 \x01(\bR\x06switch\x1av\n" +
	"\x04Etcd\x12\x1c\n" +
	"\tendpoints\x18\x01 \x03(\tR\tendpoints\x12<\n" +
	"\fdial_timeout\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\vdialTimeout\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\"\xb7\x04\n" +
	"\x04Data\x125\n" +
	"\bdatabase\x18\x01 \x01(\v2\x19.kratos.api.Data.DatabaseR\bdatabase\x12,\n" +
	"\x05redis\x18\x02 \x01(\v2\x16.kratos.api.Data.RedisR\x05redis\x12\x18\n" +
	"\asmscode\x18\x03 \x01(\tR\asmscode\x12,\n" +
	"\x05minio\x18\x04 \x01(\v2\x16.kratos.api.Data.MinioR\x05minio\x1aP\n" +
	"\bDatabase\x12\x16\n" +
	"\x06driver\x18\x01 \x01(\tR\x06driver\x12\x16\n" +
	"\x06master\x18\x02 \x01(\tR\x06master\x12\x14\n" +
	"\x05slave\x18\x03 \x01(\tR\x05slave\x1aa\n" +
	"\x05Redis\x12\x18\n" +
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Server_Pprof)(nil),        // 6: kratos.api.Server.Pprof
	(*Server_Etcd)(nil),         // 7: kratos.api.Server.Etcd
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	6,  // 5: kratos.api.Server.pprof:type_name -> kratos.api.Server.Pprof
	7,  // 6: kratos.api.Server.etcd:type_name -> kratos.api.Server.Etcd
	...
	11, // 12: kratos.api.Server.Etcd.dial_timeout:type_name -> google.protobuf.Duration
